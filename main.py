...
from variables.env_variables import FLASK_SECRET_KEY, BOT_TOKEN
...
def webhook():
    bot.remove_webhook()
    app_url = f'{SERVER_URL}/{BOT_TOKEN}'
...
if __name__ == '__main__':
    ...
    bot_server.run(host=HOST, port=PORT, debug=True, ssl_context=(CERTIFICATE_PATH, KEY_PATH))
